...
```powershell
& '.\tools\Package-Release.ps1' -Version '7.7'
```
...
2026-09-01 Version 7.7 기준 Windows SDK `10.0.26100.0`, `/W4`, `/utf-8`로 네 구성 모두 오류 0개, 자체 코드 경고 0개다. 구성별 788개·총 3,152개 자동 검증과 5종 몬스터, 9개 적 안정 ID, Refresh Peg 보장, 전투 종료 전환, 오브·유물 이미지 키와 정확한 보상 효과 문장을 통과했다. 자산 파이프라인은 16개 리소스와 15개 PNG→24-bit BMP 변환을 검증한다.
